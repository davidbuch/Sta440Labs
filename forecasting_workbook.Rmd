...
Now, instead of having all states equally correlated with each other via the heirarchy, we will estimate the correlation structure. Now $Y_k \sim N(\theta_{jt},\sigma^2_{yj})$. The evolution is as follows: 
